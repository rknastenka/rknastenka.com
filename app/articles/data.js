...
},
{
...
},
  {
    ...
    date: '2026-01-08',
    content: [
      'We credit our stagnation to digital noise to avoid the agony of an internal self. We credit our stagnation to our surroundings to avoid the agony of an internal self. We credit our stagnation to a finite world to avoid the agony of an internal self.',
      '',
      'It\'s a fact that social media is detrimental to your mind, but it is not the root cause of your laziness. On the contrast, you turned to social media because of that laziness, because you were seeking dopamine, not the other way around. There is no sense in posting a reel about how TikTok damages your intellectual ability while still actively consuming the app. No company has ever forced any of you to use its platforms. You have a mind, and no one is compelling you to choose this; it is your own decision. Harmful influences have existed since forever, and social media is merely one of them. Yes, it degrades your mind, but you are the one engaging with it; it is, in the end, your choice.',
      '',
      'You are the result of an accumulated set of choices you, yourself had made in the past. What you do today will determine what you\'ll be tomorrow. It was never social media, it was never the community, it has always been just you verse you in this lifetime',
    ],
  },
    {
